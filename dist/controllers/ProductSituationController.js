...
router.get("/product_situations", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const productRepository = data_source_1.AppDataSource.getRepository(product_situations_1.product_situations);
...
//Criar a rota POST
router.post("/product_situation", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        var data = req.body;
        const situationRepository = data_source_1.AppDataSource.getRepository(product_situations_1.product_situations);
